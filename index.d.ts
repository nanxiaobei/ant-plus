...
import { SelectProps as AntSelectProps, SelectValue as SV } from 'antd/lib/select';
...
import { TreeSelectProps as AntTreeSelectProps, SelectValue as TSV } from 'antd/lib/tree-select';
...
export interface SelectProps<SV> extends AntSelectProps<SV> {
  /**
   * 列表数据源
   */
  data?: any[];
...
export const Select: React.FC<SelectProps<SV>>;
...
export interface TreeSelectProps<TSV> extends AntTreeSelectProps<TSV> {
  /**
   * `treeData` 简写
   */
  data?: any[];
...
export const TreeSelect: React.FC<TreeSelectProps<TSV>>;
